...
<div class="login-box">
  ...
  <div class="login-box-body">
   ...
   <!--  -->
    <form action="{{getUrl('post-login')}}" method="post">
      <span class="text-danger">{{$msg}} </span>
      <div class="form-group has-feedback">
        <input type="type" class="form-control" name="name" placeholder="Email">
        <span class="fa fa-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="pass" placeholder="Password"  value="tu">
    ...
    <a href="{{getUrl('forgot-password')}} ">I forgot my password</a><br>
    <a href="{{geturl('register')}}" class="text-center">Register a new membership</a>
