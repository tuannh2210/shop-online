...
<head>
  ...
  <link rel="stylesheet" href="{{getUrl('public/plugins/font-awesome/css/font-awesome.min.css')}}"> <!-- Ionicons -->
  ...
  <link rel="stylesheet" href="{{getUrl('public/plugins/AdminLTE/css/skins/skin-blue.min.css')}}">
  <!-- Google Font -->
  <link rel="stylesheet"
            ...
            <ul class="nav navbar-nav">
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <!-- User Image -->
                            <img src="app/views/user/uploads/{{$value->avatar}}" class="img-circle" alt="User Image">
                          </div>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="app/views/user/uploads/{{$value->avatar}}" class="user-image" alt="User Image">
                  <!-- hidden-xs hides the username on small devices so only the image appears. -->
                  <span class="hidden-xs">Mr.{{$_SESSION['AUTH']['name'] }}</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{$_SESSION['AUTH']['name'] }} - Web Developer
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{getUrl("logout")}}" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{getUrl('product')}} "><i class="fa fa-briefcase"></i> <span>Product</span></a></li>
        <li><a href="{{getUrl('user')}} "><i class="fa fa-user"></i> <span>User</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
...
<!-- jQuery 3 -->
    ...
    <script src="{{getUrl('public/js/adminlte.js')}}" type="text/javascript"></script>
